...
const app = new Hono()
  ...
  .post("/seed", async (c) => {
    ...
    const teamDefs = [
      { name: "Hermes", groupId: gA.id },
      { name: "Aurora", groupId: gA.id },
      { name: "Lautaro", groupId: gA.id },
      { name: "Jeroviapy", groupId: gB.id },
      { name: "Philos", groupId: gB.id },
      { name: "Guardianes", groupId: gB.id },
      { name: "Fénix", groupId: gC.id },
      { name: "Acosta Ñu", groupId: gC.id },
      { name: "Fe", groupId: gC.id },
      { name: "León", groupId: gD.id },
      { name: "Eligio", groupId: gD.id },
      { name: "23 de Octubre", groupId: gD.id },
      { name: "Prometeo", groupId: gD.id },
    ];
